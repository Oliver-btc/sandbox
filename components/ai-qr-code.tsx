...
export function AIQRCode() {
  const rewardPageUrl = process.env.NEXT_PUBLIC_REWARD_PAGE_URL || 'http://localhost:3000/ai-reward';
  
  //Temp button integration to work with Grok
  const router = useRouter();
  const handleClaim = () => {
    router.push("https://9e5a-2601-401-c600-58f0-a881-e2fe-80de-202f.ngrok-free.app/ai-reward");  // Updated to match your URL structure
  };
